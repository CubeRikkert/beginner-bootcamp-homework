...
function doBattleWorks() {
    var heroStub = { name: 'victor', heroic: true, health: 10, weapon: { damage: 2 } }
    // Rick: I gave your heroStub a name so i could console.log it in my testing of doBattle
    var creatureStub = { name: 'testcreature', heroic: false, health: 5, weapon: { damage: 1 } }
    // Rick: I gave your creatureStub a name so i could console.log it in my testing of doBattle
    try {
